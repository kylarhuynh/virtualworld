...
public final class VirtualWorld extends PApplet {
    ...
    */
    ...
    public void mousePressed() {
        ...
        for (int x = pressed.getX() - 1; x < pressed.getX() + 2; x++) {
            for (int y = pressed.getY() - 1; y < pressed.getY() + 2; y++) {
                if (world.withinBounds(new Point(x, y)))
                    world.setBackgroundCell(new Point(x, y), new Background("pink", imageStore.getImageList("pink")));
            }
        }
        world.setBackgroundCell(new Point(pressed.getX() + 2, pressed.getY()), new Background("pink", imageStore.getImageList("pink")));
        world.setBackgroundCell(new Point(pressed.getX() - 2, pressed.getY()), new Background("pink", imageStore.getImageList("pink")));
        world.setBackgroundCell(new Point(pressed.getX(), pressed.getY() + 2), new Background("pink", imageStore.getImageList("pink")));
        world.setBackgroundCell(new Point(pressed.getX(), pressed.getY() - 2), new Background("pink", imageStore.getImageList("pink")));
